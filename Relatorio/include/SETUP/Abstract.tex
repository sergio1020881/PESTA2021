\label{Resumo}
\begin{abstract}
\par O projeto proposto é fazer uma balança utilizando um micro controlador, um sistema \textit{Embeded}.
\\
\\
...
\\
\\
A programação do \textbf{MCU}, o código as livrarias e ou drivers é para ser feito em linguagem \textbf{C}.
\\
\vfill
\par 
\textbf{Palavras Chave:} Código, Programação.
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
