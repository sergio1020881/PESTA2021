...
O segundo semestre teve inicio em 8 de Março, num ambiente de pandemia COVID-19 onde fomos forçados ao ensinamento a distancia, todo o trabalho teve de ser acompanhado \textit{online} pelos docentes, no entanto tive de organizar as tarefas pretendidas no plano abaixo descrito para poder fazer a entrega deste trabalho antes da data limite da época normal de 28 de Junho.
\\
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[H]
