...
\\
\section*{Sensor}
Para medir a massa recorreu-se a uma célula de peso que consiste em determinar a pressão exercida num dado material, neste caso um bloco de alumínio como indicado na \textit{figura} \ref{Load_Cell_1}, para isso ser possível é utilizado sensores Piezoresistivos numa montagem em ponte \textit{wheatstone} sobre essa superfície em locais determinados.
\\
\\
