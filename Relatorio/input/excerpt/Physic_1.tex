...
\begin{minipage}[c]{\linewidth}
	...
	$$ f_{(t)} = -K \; x_{(t)} $$
	\newline
	$$ f_{(t)} = -B \; \frac{\partial}{\partial t} \; x_{(t)} $$
\end{minipage}
\newline
\section*{Torque}
\begin{minipage}[c]{\linewidth}
...
\end{minipage}
\newline
\section*{Cinetic Energy}
\begin{minipage}[c]{\linewidth}
	\Large
	$$ E_{c} = \frac{1}{2} m \; v^{2} $$
\end{minipage}
\newline
\section*{Potencial Energy}
\begin{minipage}[c]{\linewidth}
	\Large
	$$ E_{p} =  m \; g \; h $$
\end{minipage}
\newline
\section*{Action Reaction}
\begin{minipage}[c]{\linewidth}
	\Large
	$$ \sum F_{action} \; - \; \sum F_{reaction} =  \sum F_{R} $$
\end{minipage}
\newline
\vspace{1cm}
\newline
