...
\\
\\
Após a aquisição deste sinal em tensão gerado pela ponte de \textit{Wheatstone} da célula de carga, o mesmo será depois ligado a um amplificador de sinal com \ac{adc} dedicado para este tipo de aplicação. Este tem 24 \textit{bits} de resolução, amplificação programável e uma taxa de transferência fisicamente configurável. O amplificador de célula de carga é designado por \textbf{HX711}, e possui um protocolo de comunicação dedicado, o protocolo  de comunicação série será realizada como o uso de um \ac{mcu}.
\\
\\
