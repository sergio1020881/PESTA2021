...
\end{figure}
O micro controlador usado neste projeto é um Atmega 128, a célula de peso é de 50Kg com uma saída de proporção de $\; 2mV/V \;$, é usado um amplificador de célula de carga com referência HX711, em que tem um protocolo de comunicação proprietário.
...
Botões são usados para saltar entre \textit{Menus} e os \textit{leds} servem como indicadores de estado, isto é, se esta a usar os parâmetros \textit{default} ou do \textit{offset}.
\\
\\
...
\\
\\
Talvez os \acs{mcu} nem deviam ter a componente \acs{adc} e realçar em meios de comunicação e memoria, tornava-se assim num sistema unicamente digital.
