...
\end{minipage}
\minipagespace{.5}
Este sistema é prático, mas também pode facilmente ser adulterado.
\\
\\
\\
...
\\
Todas as molas têm uma constante de elasticidade conhecida pela lei de Hooke \cite{book-3} \textit{equação} \ref{eq:Hooke}.\\
%\\
...
\begin{equation}
	...
	P = \frac{F}{A}
\end{equation}
As células de carga capacitivas são outro exemplo de como obter um sinal proporcional à força imposta como carga. Neste caso, é medida a sua capacidade, de acordo com o afastamento ou aproximação das placas dos elétrodos, de acordo com a expressão \ref{eq:Capacity}.
\begin{equation}
	\label{eq:Capacity}
